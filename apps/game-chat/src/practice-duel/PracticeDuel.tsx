...
const PRACTICE_SCRIPT = [
  ...
  // teacher wizard message: good.., now you see difference between spell that starts with "!" and "@" amd you know how to cause damage and protect yourself from damage
  // teacher wizard message: you are ready to practice next spell, tell me "ready" when you are ready
  // wait for the player to type "ready"
...
function Action() {
  ...
  // const castSpell = (spellName, targetType) => {
  //   try {
  //
  ...
  //     // Dispatch the action
  //
  //     // Check if the spell was successful by comparing states
  //     // A spell is successful if the state changed
  //     const isSuccess = prevState !== duelData
  //
  //     if (isSuccess) {
