...
function Content() {
  ...
  const bg = useParallax({ speed: -250, scale: [1, 1.5]  })
        ...
        <div className="relative z-100">
          <div className="container mx-auto h-[calc(100vh-120px)]">
            <div className="flex flex-col justify-center items-center text-center h-full">
              <h1 className="pt-[120px] text-6xl font-bold bg-gradient-to-r from-purple-600 to-orange-600 bg-clip-text text-transparent">
                Wizards <span className="text-black">n</span> Duels
              </h1>
              <p className="text-xl max-w-3xl text-gray-700 leading-relaxed">
          ...
          <div className="container mx-auto py-16">
            ...
            <div className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed">
              ...
              <p className="mb-6">
                Winners claim staked tokens and the opponent's equipment. Players can opt for a
                "play for fun" mode without stakes and/or loss of equipment.
              </p>
              <p>
                ...
                wizard is unique due to his developing path, ensuring no wizard is more powerful
                than another.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-100 to-blue-100 bg-opacity-95 py-14">
            <div className="container mx-auto">
              <h2 className="text-4xl font-bold mb-8 text-center">Game Modes</h2>
          ...
          <div className="py-16">
            <div className="container mx-auto px-4">
              <h2 className="text-4xl font-bold mb-12 text-center">What is New</h2>

              <div className="flex flex-col gap-4 max-w-1/2 mx-auto">
                <FeatureCard
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 bg-opacity-95 py-16 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Powered by Move smart contracts and Mysticeti consensus protocol for
                    transparent, secure, and lightning-fast gameplay.
                  </p>
                </div>
              </div>
